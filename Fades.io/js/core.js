function UI() {
    ...
    var socketip = "172.72.160.66:9700";
...
$("#backgroundColor").minicolors({
    ...
    $("#virusColor").minicolors({
		...
		defaultValue: getLocalStorage("virusColor") || "#00cc00",
        change: function(v, start1) {
    ...
    $("#virusStrokeColor").minicolors({
		...
		defaultValue: getLocalStorage("virusStrokeColor") || "#006600",
        change: function(v, start1) {
